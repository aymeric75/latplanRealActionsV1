...
def nn_task(network, path, train_in, train_out, val_in, val_out, parameters, resume=False, all_actions=None):
    ...
    net = network(path, parameters=parameters, all_actions=all_actions)
    net.train(train_in,
              val_data=val_in,
